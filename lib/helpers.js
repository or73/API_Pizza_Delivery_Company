...
const createHTMLMessage = orderObj => {
	...
	htmlMessage   += `<tbody> `;
	htmlMessage   += `<tr> `;
	htmlMessage   += `<td><strong>Order Id</strong>:</td><td></td><td>${ orderObj.shoppingCartId}</td> `;
	htmlMessage   += `</tr> `;
	htmlMessage   += `<tr> `;
	htmlMessage   += `<td><strong>Invoice</strong>:</td><td></td><td>${ orderObj.id }</td> `;
	htmlMessage   += `</tr> `;
	htmlMessage   += `<tr> `;
	htmlMessage   += `<td><strong>Authorization Date</strong>:<td></td></td><td>${ orderObj.authorizationDate}</td> `;
	htmlMessage   += `</tr> `;
	htmlMessage   += `</tbody> `;
	htmlMessage   += `</table> `;
	htmlMessage   += `</div> `;
	...
	htmlMessage   += `<tr> `;
	htmlMessage   += `<th>Product</th> `;
	htmlMessage   += `<th>Price</th> `;
	htmlMessage   += `<th>Qtty</th> `;
	htmlMessage   += `<th>Total</th> `;
	htmlMessage   += `</tr> `;
	htmlMessage   += `</thead> `;
	...
	htmlMessage   += `<tr>`;
	htmlMessage   += `<td colspan="3"></td> `;
	htmlMessage   += `<td style="border-top: 3px double black"></td> `;
	htmlMessage   += `</tr> `;
	htmlMessage   += `<tr style="height: 3px"></tr> `;
